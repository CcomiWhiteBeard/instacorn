...
def home(request):
    ...
    result_profile = {'m_no':data_profile[0],'m_id':data_profile[1],'m_name':data_profile[3],'m_img':data_profile[5],}
    ...
    msg_like = "select bo_code from insta_board_like where bo_no=1"
